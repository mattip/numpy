...
:class:`~threefry.ThreeFry` is the best choice.
...
.. csv-table::
    :header: ,Xoroshiro128,Xorshift1024,DSFMT,MT19937,Philox,ThreeFry,NumPy
    :widths: 14,14,14,14,14,14,14,14

    32-bit Unsigned Ints,3.0,3.0,3.5,3.7,6.8,6.6,3.3
    64-bit Unsigned Ints,2.6,3.0,3.4,3.8,6.9,6.6,8.8
    Uniforms,3.2,3.8,5.0,7.4,8.9,9.9,8.8
    Normals,11.0,13.9,15.8,16.9,17.8,18.8,63.0
    Exponentials,7.0,8.4,11.2,12.5,14.1,15.0,102.2
    Binomials,20.9,22.6,21.2,26.7,27.7,29.2,26.5
    Complex Normals,23.2,28.7,33.2,35.4,37.6,38.6,
    Gammas,35.3,38.6,41.3,46.7,49.4,51.2,98.8
    Laplaces,97.8,99.9,96.2,104.1,104.6,104.8,104.1
    Poissons,104.8,113.2,107.6,129.7,135.6,138.1,131.9
...
.. csv-table::
    :header: ,Xorshift1024,DSFMT,MT19937,Philox,ThreeFry,NumPy
    :widths: 14,14,14,14,14,14,14
    
    32-bit Unsigned Ints,102,99,125,229,221,111
    64-bit Unsigned Ints,114,116,143,262,248,331
    Uniforms,116,137,231,275,306,274
    Normals,126,124,153,161,170,572
    Exponentials,121,130,179,203,215,1467
    Binomials,108,105,128,133,140,127
    Complex Normals,124,125,153,162,166,
    Gammas,109,111,117,140,145,280
    Laplaces,102,102,106,107,107,106
    Poissons,108,108,124,129,132,126
    Overall,113,115,144,172,177,251
